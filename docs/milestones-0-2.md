...
- [x] Audio/tool validation and a 10-second ALSA capture command.
...
- [ ] Install and benchmark whisper.cpp models on the intended machine.
...
- [ ] Benchmark pyannote.audio as an offline quality baseline.
